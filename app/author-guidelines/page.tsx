      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="prose max-w-none text-justify text-lg">
          <p className="mb-6">
            ...
            submissions will still be possible. This conference brings together
            researchers, academicians, industry leaders, and practitioners to
            exchange ideas and explore advancements in AI, Computing,
            Blockchain, Cybersecurity, Digital and Network Security, fostering
            collaboration and innovation for a smarter, secure future.
          </p>
          ...
          {[
            ...
            <div key={index}>
              ...
              {section === "Publication" ? (
                <>
                  <p className="mb-6">
                    Select accepted and presented papers at the conference will
                    be submitted for publication through our publication
                    partners. Before final publication, proofs may be sent to
                    the corresponding author designated in the manuscript. It is
                    crucial to provide the corresponding author's correct email
                    address. Please regularly visit the conference website for
                    updates on publication specifics.
                  </p>
                  <p className="mb-6">
                    Papers found to be plagiarised/having ethical concerns
                    during any stage of the publication process (either by the
                    conference committee or by the publication partner) shall be
                    rejected immediately. If found in CRC of manuscript after
                    registration fees deposition, then registration fees will
                    NOT be refunded.
                  </p>
                </>
              ) : (
